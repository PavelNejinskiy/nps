...
public class JSONServer {
    ...
    private static class MyThreadHandler implements Runnable {
        ...
        public JSONObject receiveJSON() throws IOException {
            ...
            System.out.println("Got from client on port " + socket.getPort() + " " + jsonObject.get("key").toString() + " " + jsonObject.get("value").toString());
            int x = (int) line.get("key");
            int y = (int) line.get("value");
            jsonObject.put(x*y, x*y);
            return jsonObject;
        }
